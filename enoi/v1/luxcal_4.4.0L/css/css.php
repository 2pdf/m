...
input[type='text'], input[type='password'], textarea {font:".FONT2."; padding:0 2px; border-radius:2px; border:1px solid #666; cursor:text;}
...
input[type='submit'], input[type='button'], input[type='file'], button {font:".FONT3."; height:18px; padding:1px 2px; border-radius:2px; border:1px solid #666; cursor:pointer;}
input[type='submit']:hover, input[type='button']:hover, input[type='file']:hover, button:hover {border-color:#0080FF; background:#FFF}
select {padding:1px 2px; font:".FONT2."; height:18px; border-radius:2px; border:1px solid #666;}
select option {padding: 0 2px;}
body {background:".BGND2."; color:".TEXT1."; overflow:hidden;}
th {color:".TEXT2."; background:".BGND3.";}
...
.hide {display:none;}
.attachment:hover { text-decoration: line-through; }
"
.// ---- common ----
"
...
div.navBar {padding:0px 10px;	line-height:20px;	background:".BGND3.";	border:".BORD1.";	border-style:solid none;}
div.content {position:absolute; left:0; top:48px; right:0; bottom:30px;}
div.contentE {padding:3px 10px; font:".FONT4.";}
div.contentH {height:460px; padding:3px 10px; font:".FONT4.";}
footer {position:absolute; left:0; right:0; bottom:10px; padding:0px 10px; font-size:0.8em; background:".BGND3."; border:".BORD1."; border-style:solid none; text-align:center;}
.footLB {font:italic bold 1.1em arial,sans-serif; color:#0033FF;}
.footLR {font:italic bold 1.1em arial,sans-serif; color:#AA0066;}
div#toapBar {position: absolute; top:86px; right:60px; height:60%; width:170px; padding:4px; border:".BORD2.";".($boxRc ? ' border-radius:5px;' : '').($boxSw ? ' box-shadow:5px 5px 5px #888;' : '')." font:".FONT1."; background:".BGND1."; z-index:22; overflow:hidden; display:none;}
div#todoBar {position: absolute; top:66px; right:40px; height:60%; width:170px; padding:4px; border:".BORD2.";".($boxRc ? ' border-radius:5px;' : '').($boxSw ? ' box-shadow:5px 5px 5px #888;' : '')." font:".FONT1."; background:".BGND1."; z-index:21; overflow:hidden; display:none;}
...
div.barBody {position:absolute; top:35px; bottom:0px; width:100%; overflow:auto;}
...
div.scrollBoxMo, .scrollBoxWe, .scrollBoxDa {position:absolute; left:0; top:35px; right:0; bottom:0px; padding:0 5px; overflow-y:scroll;}
div.scrollBoxUp, .scrollBoxCh {position:absolute; left:0; top:85px; right:0; bottom:0px; padding:0 5px; overflow:auto;}
div.scrollBoxSh, .scrollBoxSe, .scrollBoxAd {position:absolute; left:0; top:135px; right:0; bottom:0px; padding:0 5px; overflow:auto;}
div.scrollBoxMx {position:absolute; left:5px; top:20px; right:5px; bottom:0px; overflow:auto;}
div.scrollBoxHead {position:absolute; left:0; top:19px; right:0; padding:0 5px; overflow-y:scroll;}
div.calHeadMx {margin-left:180px; text-align:center;}
div.catBoxMx {position:absolute; left:0; top:20px; width:180px;}
div.calBoxMx {position:absolute; left:180px; top:0; right:0; overflow-x:scroll;}

.centerBox {display:table; margin:0 auto;}
.centerBoxFix {width:870px; margin:0 auto;}
...
table.matrix th.cName {font-weight:bold;}
table.matrix tr {height:46px;}
table.matrix tr.headMx {height:20px;}
table.matrix col {width:42px;}
table.matrix td {border:".BORD1."; overflow:hidden;}
table.matrix td.cName {padding:5px;}
table.matrix td.we {background:".BGNDE.";}
table.matrix td.wd {background:".BGNDB.";}
table.matrix td.today {".CELTD."}
table.matrix td.slday {".CELSD."}
...
.dom {padding:0 2px; color:".TEXT4.";}
.firstDom {padding:0 2px; color:".TEXT2."; background:".BGND3.";}
.wnr {color:".TEXT4.";}
...
.evtBox {position:absolute; border:".BORD1."; z-index:1; overflow:hidden; border-radius: 5px; box-shadow: 10px 10px 25px grey;}
...
div.repBox {position:absolute; left:30px; bottom:120px; padding:10px; border:".BORD1."; background:".BGND5."; z-index:20; display:none;}
"
.// ---- log-in page ----
"
...
.// ---- admin pages -----
"
fieldset {width:100%; margin-bottom:10px; padding:10px; border:1px solid #888888; background:".BGND1."; border-radius:5px;}
legend {font-weight:bold; padding: 0 5px; background:".BGND1.";}
table.list {width:100%; border-spacing:4px;}
.sLabel {display:inline-block; width:320px; cursor:default; text-align:right; margin:0 6px;}
