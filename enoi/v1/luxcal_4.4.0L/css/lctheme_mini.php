...
define("BGND1","#A0B0C0"); //background top
define("BGND2","#C0D0F0"); //background body
define("BGND3","#8090A6"); //navbar / endbar / table headers
...
define("TEXT2","#FFFFFF"); //text in day headers
define("TEXT3","#FFFFFF"); //text in footer
define("TEXT4","#FF0000"); //text red

define("BORD1","1px solid #808080"); //cal borders
define("BORD3","2px solid #0000FF"); //border today
