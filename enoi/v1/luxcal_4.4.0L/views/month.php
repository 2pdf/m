...
function showEvents($date) {
	...
	foreach ($evtList[$date] as $evt) {
		...
		if ($set['popBoxMonth'] and $set['evtTemplPop']) {
...
//			$popAttr = " onmouseover=\"popM(this,'{$popText}','{$popClass}')\"";
		} else {
			$popAttr = '';
		}
...
//display header
echo "<h4 class='floatC'><a class='noPrint' href='index.php?lc&amp;cD={$prevDate}'>&nbsp;&#9664;&nbsp;</a><a href='index.php?lc&amp;cP=1'>{$header}</a><a class='noPrint' href='index.php?lc&amp;cD={$nextDate}'>&nbsp;&#9654;&nbsp;</a></h4>\n";
//display days
