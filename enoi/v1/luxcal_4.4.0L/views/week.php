...
$oneUp = $mode[0] == 'f' ? '2' : '3';
echo "<h4 class='floatC'><a class='noPrint' href='index.php?lc&amp;cD={$sDoLastW}'>&nbsp;&#9664;&nbsp;</a><a href='index.php?lc&amp;cP={$oneUp}'>{$header}</a><a class='noPrint' href='index.php?lc&amp;cD={$sDoNextW}'>&nbsp;&#9654;&nbsp;</a></h4>\n";
