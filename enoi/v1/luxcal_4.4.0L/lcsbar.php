	...
	foreach($evtList as $date => &$events) {
		...
		foreach ($events as $evt) {
			...
			if ($evt['cbx']) {
				...
				$cBoxAtt = $set['details4All'] == 1 ? "class='ssb_gen ssb_chkBox ssb_floatL ssb_point' onclick=\"checkE(this,{$evt['eid']},'{$date}');\"" : "class='ssb_gen ssb_chkBox ssb_floatL ssb_arrow'";
