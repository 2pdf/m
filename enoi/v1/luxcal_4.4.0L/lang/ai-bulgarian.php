...
"defaultView_text" => "Possible default views on calendar start-up are:<br>• Година<br>• Месец<br>• Седмица<br>• Ден<br>• Бъдещи събития<br>• Промени<br>• Matrix<br>Препоръчителни: Месеци или Бъдещ изглед на събития",
