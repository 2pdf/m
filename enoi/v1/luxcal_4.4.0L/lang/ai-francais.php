...
"defaultView_text" => "Choix possible:<br>• Année<br>• Mois<br><br>• Mois de travail (Jours ouvrés)<br>• Semaine<br><br>• Semaine de travail (Jours ouvrés)<br>• Jour<br>• Prochain(s) événement(s)<br>• Modifications<br>• Matrix<br>Choix recommandé: Mois ou Prochain(s) événement(s).",
...
"selfReg_text" => "Permet aux utilisateurs de s’inscrire eux-mêmes et d’accéder au calendrier.<br>User group to which self-registered users will be assigned.",
...
"templFields_text" => "Signification des chiffres&nbsp;:<br>1 = Champ lieu<br>2 = Champ catégorie<br>3 = Champ description<br>4 = Champ optionnel 1 (voir ci-dessous)<br>5 = Champ optionnel 2 (voir ci-dessous)<br>6 = Email de notification (seulement si une notification a été requise)<br>7 = Date/heure d’ajout/modification et le ou les utilisateurs associés<br>8: Attached pdf, image or video files as hyperlinks.<br>— L’ordre des chiffres détermine l’ordre d’affichage des champs.",
"evtTemplate_label" => "Modèles d’événement",
"evtTemplate_text" => "On spécifie les champs d’événements à afficher dans les vues générals, les vues des événements à venir et les info-bulles d’événements du calendrier au moyen d’une suite de chiffres.<br>Si un chiffre est spécifié, le champ correspondant sera affiché.",
...
"dwStartEndHour_text" => "Choix de l’heure du début et du fin d’une journée d’événements.<br>Les valeurs par défaut est de 6h à 18h, ce qui évite de perdre de la place entre minuit et 6 heures et 18 heures et minuit.<br>La fenêtre de saisie d’heure commencera/finira elle aussi à ces heures-là.",
