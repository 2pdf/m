...
"defaultView_text" => "As vistas possíveis no início do calendário são:<br>• Ano<br>• Mês<br>• Semana<br>• Dia<br>• Próximos<br>• Alterações<br>• Matrix<br>Escolha recomendada: Mês ou Próximos.",
...
"selfReg_text" => "Permitir os utilizadores registarem-se e ter acesso ao calendário.<br>User group to which self-registered users will be assigned.",
...
"YvRowsColumns_label" => "Linhas e colunas visíveis na vista Anual",
"YvRowsColumns_text" => "Número de linhas por cada quatro meses a exibir na vista Anual.<br>Recomendado: 4, o que dá 16 meses para percorrer.<br>Número de meses a exibir em cada linha na vista Ano.<br>Recomendado: 3 ou 4.",
"MvWeeksToShow_label" => "Semanas visíveis na vista Mensal",
"MvWeeksToShow_text" => "Número de semanas a exibir na vista Mensal.<br>Recomendado: 10, o que dá 2.5 meses para percorrer.<br>The values 0 and 1 have a special meaning:<br>0: display exactly 1 month - blank leading and trailing days.<br>1: display exactly 1 month - display events on leading and trailing days.",
...
"showInMView_label" => "Mostrar na vista 'Mensal'",
