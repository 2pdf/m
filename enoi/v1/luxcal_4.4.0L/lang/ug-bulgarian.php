...
This user guide has been produced by LuxSoft and has been translated by Radoslav Yovev.
...
<span class="hired">a</span>: Главен ред&nbsp;&nbsp;<span class="hired">b</span>: Меню&nbsp;&nbsp;<span class="hired">c</span>: Дни
</div>
<br>
<h4>Помощ за пазаруване</h4>
<ol>
<li><p><a href="#ov">Обобщение</a></p></li>
<li><p><a href="#li">Влез</a></p></li>
<li><p><a href="#co">Опции на календара</a></p></li>
<li><p><a href="#cv">Прегледай календара</a></p></li>
<li><p><a href="#ts">Търсене на текст</a></p></li>
<?php if ($privs > 1) { //if post rights ?>
<li><p><a href="#ae">Събитие Добави / Промени / Изтрий</a></p></li>
<?php } ?>
...
<br></li>
<li id="co"><h4>Опции на календара</h4>
...
<br></li>
<li id="cv"><h4>Прегледай календара</h4>
...
<?php } ?>
<br></li>
<li id="ts"><h4>Търсене на текст</h4>
...
<br></li>
<?php if ($privs > 1) { //if post rights ?>
<li id="ae"><h4>Събитие Добави / Промени / Изтрий</h4>
