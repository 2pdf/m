...
Additional Danish - John Schwartz. Sidst redigeret 21-02-2016
...
"optionsPanel_text" => "Aktiver/deaktiver menuer i Valg panelet.<br>• Kalendermenuen gør det muligt for admin at skifte kalendere. (enabling er kun relevant hvis flere kalendere er installeret)<br>• The view menu can be used to select one of the calendar views.<br>• Gruppemenuen kan anvendes til at vise, kun de brugere der tilhører den/de valgte gruppe(r).<br>• Menuen Brugere kan bruges til kun at vise begivenheder oprettet af den/de angivne brugere.<br>• Menuen Kategorier kan bruges til kun at vise begivenheder i den/de angivne kategorier.<br>• Menuen Sprog kan bruges til at vælge det ønskede sprog (kun relevant hvis der er installeret flere sprog).<br>Note: If no menus are selected, the option panel button will not be displayed.",
...
"defaultView_text" => "Mulige standardvisninger ved starten af kalenderen er:<br>• År<br>• Måned<br>• Uge<br>• Dag<br>• Kommende<br>• Ændringer<br>• Matrix<br>Anbefalet valg: Måned eller Kommende.",
...
"popBoxShow_label" => "Hover box med event detaljer",
"popBoxShow_text" => "Hvis aktiveret, vil en box med begivenhedsdetaljer vises, ved hovering over en begivenhed i valgt visning. Begivenhedsdetaljerne vil ikke blive vist, hvis ingen hover box begivenhedsfelter (se ovenfor) er specificeret.",
...
"grp_may_upload_files" => "Upload files tilladt",
...
"grp_no_overlap" => "Overlap ikke tilladt",
