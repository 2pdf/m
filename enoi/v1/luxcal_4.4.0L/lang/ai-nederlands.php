...
"viewButtons_text" => "Weergaveknoppen weleke op de navigatiebalk moet worden getoond kunnen worden opgegeven door middel van een een rij cijfers<br>Elk cijfer in de rij corresponddet met een weer te geven knop.<br>Als geen enkel cijfer wordt ingevuld, wordt er geen weekrgaveknop getoond.<br>Betekenis van de cijfers:<br>1: Jaar<br>2: Hele Month<br>3: Werk Maand<br>4: Hele Week<br>5: Werk Week<br>6: Dag<br>7: Binnekort<br>8: Veranderingen<br>9: Matrix<br>De volgorde van de cijfers bepalen de volgorde van de weer te geven knoppen.<br>Bijvoorbeeld: \'24\' betekent: geef de knoppen \'Hele maand\' en \'Hele week\' weer.",
"defaultView_label" => "Standaardweergave bij opstarten",
"defaultView_text" => "Mogelijke standaardweergaven bij opstarten van de kalender zijn:<br>• Jaar<br>• Maand<br>• Werkmaand *)<br>• Week<br>• Werkweek *)<br>• Dag<br>• Binnenkort<br>• Wijzigingen<br>• Matrix<br>Aanbevolen: Maand of Binnenkort<br>*) Voor werkdagen zie op deze pagina: Weergave - Werkweek dagen",
...
"xField2_label" => "Vxtra veld 2",
"xFieldx_text" => "Optioneel tekst veld. Indien dit veld voor komt in het hierna volgende model, zal het als een tekst veld worden toegevoegd aan het Activiteiten venster en aan de activiteiten in alle kalender pagina\'s. <br>• label: optional tekst label vooor het extra veld (max. 15 tekens). E.g. \'E-mailadres\', \'Website\', \'Telefoonnummer\'<br>• alle gebruikers: indien aangevinkt, zal het veld zichtbaar zijn voor alle gebruikers; anders zal het veld alleen zichbaar zijn voor ingelogde gebruikers.",
"xField_label" => "label",
"xField_public" => "alle gebruikers",
"logged_in" => 'aangemeld',
...
"YvRowsColumns_text" => "Aantal rijen van telkens vier maanden weer te geven in Jaar-weergave<br>Aanbevolen: 4, zodat door 16 maanden kan worden gescrolld.<br>Aantal maanden weer te geven in elke rij in Jaar-weergave<br>Aanbevolen: 3 of 4.",
...
"dwStartEndHour_label" => "Begin- en einduur in Dag/Week-weergave",
...
"dwTimeSlot_label" => "Tijdspanne in Dag/Week weergave",
"dwTimeSlot_text" => "Dag/Week weergave tijdspanne in aantal minuten.<br>Deze waarde, samen met het uur waarop de normale dag begint en eindigd (zie hier boven) bepalen het aantal rijen in Dag/Week weergave.",
"dwTsHeight_label" => "Tijdspanne hoogte",
"dwTsHeight_text" => "Dag/Week weergave tijdspanne hoogte in aantal pixels.",
"showInMView_label" => "Weergeven in maand-overzicht",
"showInMView_text" => "Aan/uitschakelen van de weergave in het maand-overzicht van de volgende items:<br>• URLs in de activiteiten omschrijvingen (worden weergegeven als hyperlink)<br>• images in de activiteiten omschrijvingen",
"urls" => "URL links",
"images" => "images",
...
"cronHost_text" => "Selecteer waar de cronjob draait welke periodiek het script \'lcalcron.php\' start.<br>• locaal: cronjob draait op dezelfde server<br>• elders: cronjob draait op een externe server of lcalcron.php wordt met de hand gestart (testen)<br>• IP-adres: cronjob draait op een externe server met het opgegeven IP adres.",
...
"cat_overlap" => "Overlap toegestaan",
...
"cat_time_slot" => "Tijdsinterval",
"cat_def_slot" => "Initiëel tijdsinterval (indien geen eindtijd)",
"cat_ts_no_etime" => "minutes (0: none)",
"cat_tslot_missing" => "initiëel tijdsinterval ontbreekt",
"cat_tslot_invalid" => "Ongeldig tijdsinterval",
"cat_day_color" => "Dagkleur",
...
"grp_priv_events" => "Privé<br>activiteityen",
...
"grp_no_overlap" => "geen overlap toegestaan",
...
"mdb_no_bup_match" => "Backup bestand komt niet overeen met kalender versie<br>Database niet teruggezet",
