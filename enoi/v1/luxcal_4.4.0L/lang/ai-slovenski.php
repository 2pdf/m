...
"defaultView_text" => "Možni privzeti pogledi ob zagonu koledarja so:<br>• Leto<br>• Polni mesec<br>• Delovni mesec *)<br>• Polni teden<br>• Delovni teden*)<br>• Dan<br>• Prihajajoči<br>• Spremembe<br>• Matrix<br>*) Za dneve v delovnem tednu poglejte v: Pogledi - Dnevi v delovnem tednu<br>Priporočena izbira: Mesec ali Prihajajoči",
...
"xFieldx_text" => "Optional text field. If this field is included in the event template hereafter, the field will be added as a free format text field to the Event window form and to the events displayed in all calendar views and pages.<br>• oznako: optional text label for the extra field (max. 15 characters). E.g. \'Email address\', \'Website\', \'Phone number\'<br>• public: when checked, the field will be visible to all users; otherwise the field will only be visible to logged in users.",
"xField_label" => "oznako",
...
"showInMView_label" => "Pokaži v pogledu meseca",
