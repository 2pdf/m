...
"defaultView_text" => "Possible default views on calendar start-up are:<br>• YIL<br>• AY<br>• HAFTA<br>• GÜN<br>• Gelecek Randevular<br>• Değişiklikler<br>• Matrix<br>Önerilen: Ay veya Gelecek Randevu görünümü",
...
"selfReg_text" => "Ajandaya herkes üye olabilir, düzenleme yapabilir.<br>User group to which self-registered users will be assigned.",
...
"YvRowsColumns_label" => "Yıl görünümünde ki satır ve kolon sayısı",
"YvRowsColumns_text" => "Yıl Görünümünde kaç satır olacak<br>Önerilen: 4, 4 yapılırsa 16 ayı görüntülenebilir.<br>Yıl görünümünde kaç tane kolon olacak.<br>Önerilen: 3 ve 4.",
"MvWeeksToShow_label" => "Aylık görünümde kaç hafta gösterilsin",
"MvWeeksToShow_text" => "Aylık görünümde kaç haftanın görüneceğini belirtin.<br>Önerilen: 10, Böylelikle 2,5 aylık bir görünümü elde edebilirsiniz. <br>The values 0 and 1 have a special meaning:<br>0: display exactly 1 month - blank leading and trailing days.<br>1: display exactly 1 month - display events on leading and trailing days.",
